<div class="row mb-2">
    <h4 class="col-xs-12 col-sm-6 mt-0">Data Cuti Istimewa</h4>
            ...
            <div class="card-header border-bottom">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 ml-auto text-right mb-2">
                        <a href="<?= base_url('absensi/export_cuti_istimewa/' . $this->uri->segment(3) . "?bulan=$bulan&tahun=$tahun") ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a>
                    </div>
                </div>
            </div>            
            <div class="card-body">
